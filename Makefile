...
LUCI_DEPENDS:=+luci-base +rpcd-mod-ucode +curl +openssl-util +ttyd +qrencode +libstdcpp +shadow-utils +shadow-su
LUCI_PKGARCH:=all
...
define Package/$(PKG_NAME)/install
	...
	if [ "$(CONFIG_USE_APK)" = "y" ]; then echo "apk" > $(1)/usr/share/openclaw/PACKAGE_FORMAT; else echo "ipk" > $(1)/usr/share/openclaw/PACKAGE_FORMAT; fi
endef
